...
export const Editor = (props: { reduxState: ApplicationState, setSelectedNode: (id: string) => void }) => {
    ...
    const nodes = Object.values(props.reduxState.nodes).map(node => <RiverNode key={node.id} node={node} selected={props.reduxState.selectedNodeId === node.id} />)
