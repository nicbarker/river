...
import { RiverNode, LogNode, VariableNodes, NodeType, TextBlockObjectType, ValueType, TextBlock } from "lib/interpreter";
...
const reducer = (state: ApplicationState, action: ReducerAction) => {
  ...
  // --------------------------------------------------
      ...
      newState.selectedNodeId = action.payload.selectedNodeId
  }
  // --------------------------------------------------
